 ...
 */
const clouds = [
  { top: '8%', width: '42vw', height: '10vh', delay: '-12s', speed: 'cloud-slow', opacity: 0.22 },
  { top: '18%', width: '28vw', height: '7vh', delay: '-32s', speed: 'cloud-medium', opacity: 0.16 },
  { top: '34%', width: '56vw', height: '12vh', delay: '-5s', speed: 'cloud-slow', opacity: 0.18 },
  { top: '6%', width: '20vw', height: '6vh', delay: '-22s', speed: 'cloud-fast', opacity: 0.12 },
  { top: '52%', width: '36vw', height: '9vh', delay: '-44s', speed: 'cloud-medium', opacity: 0.14 },
]
